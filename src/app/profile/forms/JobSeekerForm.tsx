  ...
  return (
    <form onSubmit={handleSubmit} className={cardClass}>
      <div className="text-center mb-8">
        <h2 className={`text-3xl font-bold mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>Job Seeker Profile</h2>
        <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>Complete your profile to stand out to employers</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          {uploading && <p className={`text-sm mt-2 ${darkMode ? "text-indigo-400" : "text-indigo-600"}`}>Uploading photo...</p>}
        </div>
