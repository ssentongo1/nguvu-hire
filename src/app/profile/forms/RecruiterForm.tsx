  ...
  return (
    <form onSubmit={handleSubmit} className={cardClass}>
      <div className="text-center mb-6">
        <h2 className={`text-xl sm:text-2xl font-bold mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>Recruiter Profile</h2>
        <p className={`text-xs sm:text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Complete your recruiter profile to connect with top talent</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="text-center">
          ...
          {uploading && <p className={`text-xs mt-1 ${darkMode ? "text-purple-400" : "text-purple-600"}`}>Uploading photo...</p>}
        </div>
